...
<RealizationSection>
    ...
    <RealizationButtonContainer>
    <RealizationButton isActive={isActive} name="all"  onClick={()=>setActive("all")}>Wszystkie</RealizationButton>
    <RealizationButton isActive={isActive} name="private"  onClick={()=>setActive("private")}>Prywatne</RealizationButton>
    <RealizationButton isActive={isActive} name="commercial"  onClick={()=>setActive("commercial")}>Komercyjne</RealizationButton>
    </RealizationButtonContainer>

{isActive==="all" && <RealizationCard images={imagesAll} name="all"></RealizationCard>}
{isActive==="private" && <RealizationCard images={imagesPriv} name="private" ></RealizationCard>}
{isActive==="commercial" && <RealizationCard images={imagesCom} name="commercial"></RealizationCard>}
