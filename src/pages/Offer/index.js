...
const { t }=useTranslation();
    ...
    <OfferIntroduction>
        ...
        <OfferIntro>Dbamy, aby nasze wnętrza były nie tylko piękne, ale przede wszystkim przemyślane i funkcjonalne.
        </OfferIntro>
        <OfferText>Realizujemy projekty zarówno mieszkalne, jak i biurowe. Cenimy oryginalność, wykorzystanie nowoczesnych trendów, a naszym priorytetem jest zrozumienie potrzeb Klienta, by tworzyć przestrzenie, w których chce się przebywać.
        </OfferText>
    </OfferIntroduction>
    ...
    <OfferArticleRightHeadline>Realizujemy</OfferArticleRightHeadline>
        <OfferArticleRightText>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</OfferArticleRightText>
    </OfferArticleRightContainer>
        </OfferArticleRight>
    </OfferArticleContainer>
    </>
